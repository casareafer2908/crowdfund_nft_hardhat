...
module.exports = {
  defaultNetwork: "hardhat", networks: {
    hardhat: {
      chainId: 31337 // gasPrice: 130000000000,
    }, rinkeby: {
      url: RINKEBY_RPC_URL, accounts: [PRIVATE_KEY], chainId: 4, blockConfirmations: 6
    }
  }, solidity: {
    compilers: [{
      version: "0.8.8"
    ...
    noColors: true // coinmarketcap: COINMARKETCAP_API_KEY,
  }, namedAccounts: {
    deployer: {
